            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Kasa Hareketleri</h4>
                        <div class="row row-cols-lg-auto g-3 align-items-center">
                            <div class="col-12">
                                <label class="visually-hidden" for="inlineFormInputGroupUsername">Kasa Hareketleri?</label>
                                <input type="text" class="form-control" wire:model.live.debounce.250ms="search" placeholder="Kasa Hareketleri?">
                            </div>
                            <!--end col-->
                            <div class="col-12">
                        ...
                        <div class="row g-3">
                            <div class="col-lg-12">
                                <table class="table table-nowrap">
                                    ...
                                    <tbody>
                                        @foreach($vaultFicheLines as $fiche)
                                            <tr>
